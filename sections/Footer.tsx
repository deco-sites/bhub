      ...
      <div className="mx-auto max-w-6xl px-3 sm:px-2 py-12 sm:py-24">
        <div className="flex flex-col md:flex-row items-center md:items-start text-center md:text-left">
          <div className="flex flex-col w-full md:w-1/4 pl-3 pr-12">
            ...
            <p className="mb-5 font-medium">Suporte: meajuda@bhub.ai</p>
          </div>
          <div className="flex flex-col flex-1 px-3">
            <ul className="flex flex-col md:flex-row mb-4 font-medium justify-center md:justify-start">
              <li className="mr-2 hover:cursor-pointer hover:underline">
                Sobre Nós
              </li>
              <li className="mr-2 hover:cursor-pointer hover:underline">
                Como funciona
            ...
            <ul className="flex flex-col md:flex-row mb-4 font-medium justify-center md:justify-start">
              <li className="mr-2 hover:cursor-pointer hover:underline">FAQ</li>
              <li className="mr-2 hover:cursor-pointer hover:underline">
                Fale com a gente
              </li>
            </ul>
            <a
              href=""
              className="flex mb-4 font-medium justify-center md:justify-start">
          ...
          <div className="flex flex-col w-full md:w-1/5 px-3">
            <div>
              <p>Siga a BHub nas Redes Sociais</p>
              <ul className="flex justify-center md:justify-start">
                <li className="mr-4 mt-5">
                  <svg
